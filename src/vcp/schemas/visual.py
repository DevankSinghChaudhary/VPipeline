...
class asset(BaseModel):
    ...
    queries: list[str] = Field(description="Queries to search for on wikimedia/web for gathering appropriate assets/images of subject. Create appropriate query as it will be searching on wikimedia. SHORT AND TO THE POINT")
